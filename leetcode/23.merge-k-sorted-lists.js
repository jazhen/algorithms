...
var mergeKLists = function(lists) {
  const minHeap = new Heap([], (a, b) => a && b && a.val < b.val);

  // add all LLs into the heap
  ...
  // add the min to the return LL
  // add the extracted LL's next to the heap, if it still has elements remaining
