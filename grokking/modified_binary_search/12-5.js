...
console.log(searchMinDiffElement([4, 6, 10], 7)); // 6
console.log(searchMinDiffElement([4, 6, 10], 4)); // 4
console.log(searchMinDiffElement([4, 6, 10], 12)); // 10
console.log(searchMinDiffElement([4, 6, 10], 17)); // 10
